(function () {
    ...
    TeamRegister.$inject = ['TeamServiceFactory', 'GameServiceFactory', '$routeParams', '$window', '$location', 'teamRequestServiceFactory', 'OpenGameServiceFactory'];

    function TeamRegister(TeamService, GameService, $routeParams, $window, $location, TeamRequestService, OpenGameService) {
        let vm = this;
        vm.teamName = "";
        vm.fullName = "";
        vm.phone = "";
